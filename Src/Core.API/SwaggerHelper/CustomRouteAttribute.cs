...
namespace Core.API.SwaggerHelper
{
    /// <summary>
    ...
    public class CustomRouteAttribute : RouteAttribute, IApiDescriptionGroupNameProvider
    {
        ...
        public CustomRouteAttribute(ApiVersions version, string actionName = "[action]") : base("/{__tenant__}/api/" + version.ToString() + "/[controller]/" + actionName)
        {
